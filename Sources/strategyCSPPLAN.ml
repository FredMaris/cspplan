class fluent atom =
object
  inherit [action] AlgoCSPPLAN.fluent atom
end

and action ope params duration quality prec add del =
object
  inherit [fluent] AlgoCSPPLAN.action ope params duration quality prec add del
end
...
object
  ...
  inherit [fluent, action, plan] AlgoCSPPLAN.t
