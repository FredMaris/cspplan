...
object (self)
  inherit ['action] PGraphCSPPLAN.fluent atom
...
object (self)
  inherit ['fluent] PGraphCSPPLAN.action ope params duration quality prec add del

  val value = Array.create PGraphCSPPLAN.max_level false
...
object (self)
  inherit ['fluent, 'action, 'plan] PGraphCSPPLAN.t
